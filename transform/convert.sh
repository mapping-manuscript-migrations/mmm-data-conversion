...
rapper -i turtle /output/_bibale_linked_all_people.ttl -o turtle > /output/bibale_cidoc.ttl
rapper -i turtle /output/_bodley_linked_all_people.ttl -o turtle > /output/bodley_cidoc.ttl
rapper -i turtle /output/_sdbm_linked_all_people.ttl -o turtle > /output/sdbm_cidoc.ttl
